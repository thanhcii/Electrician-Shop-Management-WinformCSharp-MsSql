...
namespace GUI_Tier
{
    public partial class frmBanHang : Form
    {
        ...
        private void txtSoLuong_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (txtSoLuong.Text != "")
                {
                    ...
                    {
                        long s = long.Parse(txtDG.Text) * long.Parse(txtSoLuong.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    thanhtien += long.Parse(txtTT.Text);
                    ...
                    ctpdh.thanhtien = long.Parse(txtTT.Text);
        ...
        private void txtSL_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (txtSL.Text != "")
                {
                    ...
                    {
                        long s = long.Parse(txtDonGia.Text) * long.Parse(txtSL.Text);
        ...
        private void btnxoaspn_Click(object sender, EventArgs e)
        {
            ...
            {
                SanPhamDTO sp = new SanPhamDTO();
                sp.ma_sp = dgvCTPDH.CurrentRow.Cells[2].Value.ToString();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                SanPhamDTO sp = new SanPhamDTO();
                sp.ma_sp = dgvCTHD.CurrentRow.Cells[2].Value.ToString();
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                e.Graphics.DrawString("Tên khách hàng:" + txtMaKhachHang_PDH.Text, new Font("Times New Roman", 13), Brushes.Black, new Point(30, x += 20));
                ...
                for (int i = 0; i < dgvCTPDH.RowCount-1; i++)
                {
                    ...
                    e.Graphics.DrawString(dgvCTPDH.Rows[i].Cells[6].Value.ToString(), new Font("Times New Roman", 13), Brushes.Black, new Point(500, x));
                }
        ...
        private void printDocument2_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < dgvCTHD.RowCount - 1; i++)
                {
                    ...
                    e.Graphics.DrawString(dgvCTHD.Rows[i].Cells[6].Value.ToString(), new Font("Times New Roman", 13), Brushes.Black, new Point(500, x));
                }
                e.Graphics.DrawString("Tổng: " + txtTongthanhtoan.Text, new Font("Times New Roman", 13), Brushes.Black, new Point(500, x += 20));
            }
            catch (Exception ex)
